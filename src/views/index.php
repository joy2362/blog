...
<head>
    ...
    <title>Blog</title>
    <?php require realpath('src/layouts/head.php')?>
</head>
<body>
<?php require realpath('src/layouts/header.php')?>

<div class="container-fluid">
    <main class="tm-main">
        <?php require realpath('src/layouts/search.php')?>
        <div class="row tm-row">
            <article class="col-12 col-md-6 tm-post">
                <hr class="tm-hr-primary">
                <a href="post.php" class="effect-lily tm-post-link tm-pt-60">
                    <div class="tm-post-link-inner">
                        <img src="/src/assets/img/img-01.jpg" alt="Image" class="img-fluid">
                    </div>
            ...
            <article class="col-12 col-md-6 tm-post">
                ...
                <a href="post.php" class="effect-lily tm-post-link tm-pt-60">
                    <div class=" tm-post-link-inner">
                        <img src="/src/assets/img/img-02.jpg" alt="Image" class="img-fluid">
                    </div>
                    <span class="position-absolute tm-new-badge">New</span>
            ...
            <article class="col-12 col-md-6 tm-post">
                ...
                <a href="post.php" class="effect-lily tm-post-link tm-pt-20">
                    <div class="tm-post-link-inner">
                        <img src="/src/assets/img/img-03.jpg" alt="Image" class="img-fluid">
                    </div>
            ...
            <article class="col-12 col-md-6 tm-post">
                ...
                <a href="post.php" class="effect-lily tm-post-link tm-pt-20">
                    <div class="tm-post-link-inner">
                        <img src="/src/assets/img/img-04.jpg" alt="Image" class="img-fluid">
                    </div>
            ...
            <article class="col-12 col-md-6 tm-post">
                ...
                <a href="post.php" class="effect-lily tm-post-link tm-pt-20">
                    <div class="tm-post-link-inner">
                        <img src="/src/assets/img/img-05.jpg" alt="Image" class="img-fluid">
                    </div>
            ...
            <article class="col-12 col-md-6 tm-post">
                ...
                <a href="post.php" class="effect-lily tm-post-link tm-pt-20">
                    <div class="tm-post-link-inner">
                        <img src="/src/assets/img/img-06.jpg" alt="Image" class="img-fluid">
                    </div>
        ...
        <?php require realpath('src/layouts/footer.php')?>
    </main>
</div>
<?php require realpath('src/layouts/script.php')?>
</body>
</html>